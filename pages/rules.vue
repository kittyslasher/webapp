<template>
<v-container class="md-12">
    <v-container>
        
        <br>
        </v-container> 
      <v-row>
        <v-col class="md-6 text-center">
            
        <img
           style="height:75%;width:80%;padding-top:13%;"
            src="/bill_img.png"
            alt="Vuetify.js"
            class="mb-5"
        >
    ...
    <v-row>
        <v-col class="md-12 text-center">
            <h1>Generic Rules </h1>
        </v-col>
    </v-row>

    <v-row class="bill-text" >
        <v-col class="md-5 " style="padding:0 0 0 0;margin: 0 0px 0px ;">
            <div>
                <ul id="example-1">
                    ...
                    <li >
                     ...
                     <li >
                        <p> <b>Every Pokémon species has a fixed cost in Pokéballs</b>. You’ll need only 0.1 PKBL to catch a Pikachu - the most common Pokémon - while in order to catch Mewtwo, you will need a bag with 22,145.00PKBL.</p>
                    </li>
                     <li >
                     ...
                     <li >
                        <p>Every time you catch a Pokémon in “the Wild” with PKBL, the respective <b>NFT is added to your PokéDex</b> while the <b>PKBL used for that are staked in “The wild”</b> </p>
                    </li>
                     <li >
                        <p>You can set your Pokémon free in “The wild” whenever you want and <b>get your Pokéballs back again</b>. </p>
                    </li>
                     <li >
                        <p><b> If you set free an evolved Pokémon in “The wild”, you will get the total amount of PKBL </b> used for catching its’ lower evolutionary forms. </p>
                    </li>
                     <li >
                        <p>Check all Pokémon details on the table on the right. </p>
                    </li>

                    <br>
                     <li style="list-style:none;" class="" >
                         
                        <h3> And now how’s this all gonna play out? <br> The Pokémon race: </h3> 
                    </li>
                     <br>
                     ...
                     <li >
                        <p>During the Pokémon race <b>not every Pokémon species will be set free.</b> </p>
                    </li>
                     <li >
                        <p>Only after the end of the Pokémon Race you will be able to access “The wild” freely and catch  or release any Pokémon you want or get your PKBL back. </p>
                    </li>
                     <li >
            ...
            <div>
               <blockquote class="blockquote">
                    ...
                    Let the race begin and go catch’em all.
                    <footer>
                    <small>
                        <em>&mdash; Bill </em>
                    </small>
        ...
        <v-col class="md-7 text-center" style="padding: 0 0 0 0;">
    ...
    <v-row  style="padding:0px;margin:0px;" class="mt-10">
        <v-col class="md-12 text-center "  style="padding:0px;margin:0px;">
            <h1> Is the Pokémon Race the whole thing? </h1>
        </v-col>
    </v-row>
    <v-row  style="padding:0px;margin:0px;" class="mt-5" >
        <v-col class="md-12 text-left" style="padding:0px;margin:0px;" justify="justify" >
            <p class="bill-text road_map">Of course not. It’s just the beginning and a way to set all Pokémon free in the crypto world and let them find they’re real trainers.
                The race will be the opportunity window for you to claim your exclusive right to some Pokémon. After that, things will only get more interesting and here is the roadmap for that:
            </p>
             <p class="bill-text road_map"></p>
        </v-col>
    </v-row>
   
  
    <v-row  style="padding:0px;margin:4%;">
        <v-col class="md-12 text-center "  style="padding:0px;margin:0px;">
            <div class="node_map">
                <img  class="img_map" :src="getRoadmap()">
            </div>
        </v-col>
    </v-row>
...
export default {
  ...
  name: 'app-about',
  components: {AboutTable},
   methods: {
      getRoadmap ()
      {
           return require('@/assets/img/roadmap_2.png'); 
      }
  },
  data : function(){
      return {
